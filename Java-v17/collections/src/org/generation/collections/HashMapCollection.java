...
public class HashMapCollection {
	...
	public static void main(String[] args) {
		...
		//Add -> Agregando elementos "clave/valor" (.put)
		...
		capitals.put("Toluca "," Estado de Mexico");
		...
		for(Map.Entry<String, Integer> prom: calificaciones.entrySet()) {
			System.out.println("La calificacion de "+prom.getKey()+" es de "+ prom.getValue());
		}
